...
Pick "Set up an agent that improves CI/CD reliability over time" after the
analytics demo, or from the analytics demo's next-step menu, to schedule the
same analysis as a recurring check. The demo scans your
