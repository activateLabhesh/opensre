...
The browser flow creates or signs in to your OpenSRE account with GitHub. A successful login connects GitHub and activates the hosted model; no separate LLM key is required.
